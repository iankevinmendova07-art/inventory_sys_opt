    ...
    <div id="content">
        ...
        <div class="container-fluid p-4">
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-3">
                    <div class="card stat-card py-2 px-3 border-start border-4 border-primary" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#addItemModal">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <h5 class="fw-bold text-dark mb-0"><i class="bi bi-plus-circle text-primary me-1"></i>Add Item</h5>
                            </div>
                            <div class="fs-4 text-primary opacity-50"><i class="bi bi-box-seam"></i></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card stat-card py-2 px-3 border-start border-4 border-warning shadow-sm" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#addToCartModal">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <h5 class="fw-bold text-dark mb-0">Release Item</h5>
                            </div>
                            <div class="fs-4 text-warning opacity-50"><i class="bi bi-cart-check"></i></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="border-radius: 12px;">
            <div class="modal-header text-white" style="background-color: #0D3B66;">
                <h5 class="modal-title fw-bold" id="addItemModalLabel">Add Non-Consumable Item</h5>
                ...
                <form id="addItemForm">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="unitCost" name="unit_cost" placeholder="0.00">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="totalCost" class="form-label fw-semibold">Total Cost</label>
                            <input type="number" step="0.01" class="form-control" id="totalCost" name="total_cost" placeholder="0.00">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="qtyPropertyCard" class="form-label fw-semibold">Qty per Property Card</label>
                            <input type="number" class="form-control" id="qtyPropertyCard" name="qty_property_card" value="0" required>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="cartRecipient" name="recipient">
                ...
                <form id="editItemForm">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="editUnitCost" name="unit_cost">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="editTotalCost" class="form-label fw-semibold">Total Cost</label>
                            <input type="number" step="0.01" class="form-control" id="editTotalCost" name="total_cost">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
...
<!-- Add to Cart / Release Item Modal -->
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="border-radius: 12px;">
            ...
            <div class="modal-body">
                <form id="cartForm">
                    <div class="mb-3">
                        <label for="cartPropertyNumber" class="form-label fw-semibold">Property Number</label>
                        <input type="text" class="form-control" id="cartPropertyNumber" name="property_number" placeholder="Enter property number" required>
                    </div>
                    <div class="mb-3">
                        <label for="cartDescription" class="form-label fw-semibold">Description</label>
                        <textarea class="form-control" id="cartDescription" name="description" placeholder="Item description" rows="2" readonly required></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="cartUnitOfMeasure" class="form-label fw-semibold">Unit of Measure</label>
                        <input type="text" class="form-control" id="cartUnitOfMeasure" name="unit_of_measure" placeholder="Unit of measure" readonly required>
                    </div>
                    <div class="mb-3">
                        <label for="cartCategory" class="form-label fw-semibold">Category / Item Type</label>
                        <input type="text" class="form-control" id="cartCategory" name="category" placeholder="Category" readonly required>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="cartUnitCost" class="form-label fw-semibold">Unit Cost</label>
                            <input type="number" step="0.01" class="form-control" id="cartUnitCost" name="unit_cost" placeholder="0.00" readonly>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="cartTotalCost" class="form-label fw-semibold">Total Cost</label>
                            <input type="number" step="0.01" class="form-control" id="cartTotalCost" name="total_cost" placeholder="0.00" readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="cartQtyPropertyCard" class="form-label fw-semibold">Qty per Property Card</label>
                            <input type="number" class="form-control" id="cartQtyPropertyCard" name="qty_property_card" value="0" readonly required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="cartQtyPhysicalCount" class="form-label fw-semibold">Qty per Physical Count</label>
                            <input type="number" class="form-control" id="cartQtyPhysicalCount" name="qty_physical_count" value="0" readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="cartShortageOverageQty" class="form-label fw-semibold">Shortage/Overage Qty</label>
                            <input type="number" class="form-control" id="cartShortageOverageQty" name="shortage_overage_qty" value="0" readonly>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="cartShortageOverageValue" class="form-label fw-semibold">Shortage/Overage Value</label>
                            <input type="number" step="0.01" class="form-control" id="cartShortageOverageValue" name="shortage_overage_value" value="0.00" readonly>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="cartRemarks" class="form-label fw-semibold">Remarks</label>
                        <textarea class="form-control" id="cartRemarks" name="remarks" rows="2" placeholder="Remarks" readonly></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="cartRecipient" class="form-label">Recipient</label>
